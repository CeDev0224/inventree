...
export const ModelInformationDict: ModelDict = {
  ...
  partparametertemplate: {
    label: () => t`Product Parameter Template`,
    label_multiple: () => t`Product Parameter Templates`,
  ...
  parttesttemplate: {
    label: () => t`Product Test Template`,
    label_multiple: () => t`Product Test Templates`,
  ...
  supplierpart: {
    label: () => t`Supplier Product`,
    label_multiple: () => t`Supplier Products`,
  ...
  manufacturerpart: {
    label: () => t`Manufacturer Product`,
    label_multiple: () => t`Manufacturer Products`,
  ...
  partcategory: {
    ...
    label_multiple: () => t`Product Categories`,
