  ...
  return useMemo(() => {
    ...
    return {
      part: {
        ...
        exclude: true,
        label: t`Product`,
        description: t`Select the product to install`,
...
function stockTransferFields(items: any[]): ApiFormFieldSet {
  ...
  const fields: ApiFormFieldSet = {
    items: {
      ...
      headers: [t`Product`, t`Location`, t`Stock`, t`Move`, t`Actions`]
    },
    location: {
      filters: {
        structural: false
...
function stockRemoveFields(items: any[]): ApiFormFieldSet {
  ...
  const fields: ApiFormFieldSet = {
    items: {
      ...
      headers: [t`Product`, t`Location`, t`In Stock`, t`Remove`, t`Actions`]
    },
    notes: {}
  };
...
function stockAddFields(items: any[]): ApiFormFieldSet {
  ...
  const fields: ApiFormFieldSet = {
    items: {
      ...
      headers: [t`Product`, t`Location`, t`In Stock`, t`Add`, t`Actions`]
    },
    notes: {}
  };
...
function stockCountFields(items: any[]): ApiFormFieldSet {
  ...
  const fields: ApiFormFieldSet = {
    items: {
      ...
      headers: [t`Product`, t`Location`, t`In Stock`, t`Count`, t`Actions`]
    },
    notes: {}
  };
...
function stockChangeStatusFields(items: any[]): ApiFormFieldSet {
  ...
  const fields: ApiFormFieldSet = {
    items: {
      ...
      headers: [t`Product`, t`Location`, t`In Stock`, t`Actions`]
    },
    status: {},
    note: {}
  };
