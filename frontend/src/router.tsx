...
// Add the new public route component
export const PublicProducts = Loadable(
  lazy(() => import('./pages/Public/ProductPage'))
);
export const PublicCustomerRegister = Loadable(
  lazy(() => import('./pages/Public/CustomerRegister'))
);
export const PublicOrderDetail = Loadable(
  lazy(() => import('./pages/Public/OrderDetail'))
);

export const CartPage = Loadable(
  lazy(() => import('./pages/Public/CartPage'))
);
...
export const routes = (
  <Routes>
    ...
    <Route path='/' errorElement={<ErrorPage />}>
      ...
      <Route path='/customer-register' element={<PublicCustomerRegister />} />
      <Route path="/order/:productId" element={<PublicOrderDetail />} />
      <Route path="/order-success" element={<OrderSuccessPage />} />   
      <Route path='/cart' element={<CartProvider><CartPage /></CartProvider>} />
      <Route path='/products' element={<CartProvider><PublicProducts /></CartProvider>} />
    </Route>
  </Routes>
);
