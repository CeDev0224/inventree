  ...
  return [
    {
      name: 'active',
      label: t`Active`,
      description: t`Show stock for active products`
    },
    {
      name: 'status',
      label: t`Status`,
    ...
    },
    {
      name: 'assembly',
      label: t`Assembly`,
      description: t`Show stock for assembled products`
    },
    {
      name: 'allocated',
      label: t`Allocated`,
    ...
    },
    {
      ...
      description: t`Include stock items for variant products`
    },
    {
      name: 'consumed',
      label: t`Consumed`,
